...
namespace WasteDisposalManagement.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required, Display(Name = "First Name"), StringLength(100, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 0)]
            public string FirstName { get; set; }

            [Required, Display(Name = "Last Name"), StringLength(100, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 0)]
            public string LastName { get; set; }

            [Required, Display(Name = "Phone Number"), MaxLength(11, ErrorMessage = "Phone Number cannot be less or greater than 11")]
            ...
            [Required, Display(Name = "City"), StringLength(100, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 0)]
            public string City { get; set; }

            [Required, Display(Name = "State"), StringLength(100, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 0)]
